...
Per-direction trade limits are configured per strategy and index via keys like:
- `max_trades_per_day_long_nifty_orb`
- `max_trades_per_day_short_banknifty_crossover`
